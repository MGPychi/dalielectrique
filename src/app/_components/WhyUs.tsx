...
const features = [
  {
    ...
    description:
      "Our team consists of highly skilled, certified engineers and technicians, excelling in a wide range of electrical services. We prioritize continuous safety training to stay updated on the latest technologies and ensure exceptional attention to detail. When we take on a project, it's completed with the highest level of professionalism.",
  },
  {
    icon: DollarSign,
    title: "Upfront Pricing",
    description:
      "Transparency is key. We provide clear, upfront pricing for every job, so there are no surprises. You'll know the cost before we begin, and with our money-back guarantee, we ensure your complete satisfaction.",
  },
  {
    icon: Heart,
    title: "Friendly and Knowledgeable",
    description:
      "We’re a family-owned business, and we treat every customer with care and respect. Our team is approachable, knowledgeable, and committed to offering the best service. We continuously train our staff to ensure they deliver outstanding results every time.",
  },
];
